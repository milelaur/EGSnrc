...
win32 {
    ...
    DEFINES += VDEBUG
    RC_FILE = egs_view.rc
    LIBS	+= ../dso/$$my_machine/egspp.lib ../dso/$$my_machine/egs_input_block.lib
...
unix {
    ...
    macx {
        LIBS  += -L../dso/$$my_machine -legspp -legs_input_block
    ...
    !macx {
       ...
       !contains( CONFIG, static ){
         ...
         TARGET = egs_view
         LIBS += -L../dso/$$my_machine -Wl,-rpath,$$hhouse/egs++/dso/$$my_machine -legspp -legs_input_block
        }
        contains( CONFIG, static ){
            message( "Static build ..." )
            DESTDIR = ../../pieces/linux
            #LIBS += -L../dso/$$my_machine -Wl,-rpath,$$hhouse/egs++/dso/$$my_machine -legspp # Fixes path to library
            LIBS += -L$$hhouse/egs++/dso/$$my_machine -legspp -legs_input_block                                # Relies on LD_LIBRARY_PATH
