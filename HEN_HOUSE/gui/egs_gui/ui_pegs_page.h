...
public:
    ...
    void setupUi(QWidget *EGS_PegsPage)
    {
        if (EGS_PegsPage->objectName().isEmpty())
            EGS_PegsPage->setObjectName(QStringLiteral("EGS_PegsPage"));
        ...
        composition_table->setObjectName(QStringLiteral("composition_table"));
        composition_table->setRowCount(20);
        composition_table->setColumnCount(2);
        ...
        medname_le->setObjectName(QStringLiteral("medname_le"));
        ...
        medtype_cbox->setObjectName(QStringLiteral("medtype_cbox"));
        ...
        rho_group->setObjectName(QStringLiteral("rho_group"));
        ...
        rho_le->setObjectName(QStringLiteral("rho_le"));
        ...
        is_gas->setObjectName(QStringLiteral("is_gas"));
        ...
        dc_group->setObjectName(QStringLiteral("dc_group"));
        ...
        dc_where->setObjectName(QStringLiteral("dc_where"));

        hboxLayout4->addWidget(dc_where);

        dc_file = new QLineEdit(dc_group);
        dc_file->setObjectName(QStringLiteral("dc_file"));

        hboxLayout4->addWidget(dc_file);

        dc_button = new QPushButton(dc_group);
        dc_button->setObjectName(QStringLiteral("dc_button"));
        ...
        ae_le->setObjectName(QStringLiteral("ae_le"));

        hboxLayout5->addWidget(ae_le);

        ae_units = new QComboBox(groupBox5);
        ae_units->setObjectName(QStringLiteral("ae_units"));
        ...
        ap_le->setObjectName(QStringLiteral("ap_le"));

        hboxLayout6->addWidget(ap_le);

        ap_units = new QComboBox(groupBox5);
        ap_units->setObjectName(QStringLiteral("ap_units"));
        ...
        ue_le->setObjectName(QStringLiteral("ue_le"));

        hboxLayout7->addWidget(ue_le);

        ue_units = new QComboBox(groupBox5);
        ue_units->setObjectName(QStringLiteral("ue_units"));
        ...
        up_le->setObjectName(QStringLiteral("up_le"));

        hboxLayout8->addWidget(up_le);

        up_units = new QComboBox(groupBox5);
        up_units->setObjectName(QStringLiteral("up_units"));
        ...
        new_data_file->setObjectName(QStringLiteral("new_data_file"));
        ...
        append_to_datafile->setObjectName(QStringLiteral("append_to_datafile"));
        ...
        ofile_le->setObjectName(QStringLiteral("ofile_le"));

        hboxLayout10->addWidget(ofile_le);

        ofile_b = new QPushButton(groupBox10);
        ofile_b->setObjectName(QStringLiteral("ofile_b"));
        ...
        details_b->setObjectName(QStringLiteral("details_b"));
    ...
    {
        EGS_PegsPage->setWindowTitle(QApplication::translate("EGS_PegsPage", "Form1", Q_NULLPTR));
        groupBox6->setTitle(QApplication::translate("EGS_PegsPage", "Medium composition", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = composition_table->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("EGS_PegsPage", "Element", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = composition_table->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("EGS_PegsPage", "Fraction by weight", Q_NULLPTR));
        groupBox11->setTitle(QApplication::translate("EGS_PegsPage", "Medium name", Q_NULLPTR));
        groupBox8->setTitle(QApplication::translate("EGS_PegsPage", "Medium type", Q_NULLPTR));
        medtype_cbox->clear();
        medtype_cbox->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "Element", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "Compound", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "Mixture", Q_NULLPTR)
        );
        rho_group->setTitle(QApplication::translate("EGS_PegsPage", "Mass density", Q_NULLPTR));
        comboBox2->clear();
        comboBox2->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "g/cm**3", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "kg/m**3", Q_NULLPTR)
        );
        groupBox3->setTitle(QApplication::translate("EGS_PegsPage", "Options", Q_NULLPTR));
        dc_icru_check->setText(QApplication::translate("EGS_PegsPage", "ICRU density correction", Q_NULLPTR));
        rad_icru_check->setText(QApplication::translate("EGS_PegsPage", "ICRU radiative stopping power", Q_NULLPTR));
        rayleigh_check->setText(QApplication::translate("EGS_PegsPage", "Include Rayleigh data", Q_NULLPTR));
        is_gas->setText(QApplication::translate("EGS_PegsPage", "Medium is a gas", Q_NULLPTR));
        gaspLabel->setText(QApplication::translate("EGS_PegsPage", "gas pressure", Q_NULLPTR));
        gaspUnits->setText(QApplication::translate("EGS_PegsPage", "atm", Q_NULLPTR));
        dc_group->setTitle(QApplication::translate("EGS_PegsPage", "Density correction file", Q_NULLPTR));
        textLabel5->setText(QApplication::translate("EGS_PegsPage", "Look in", Q_NULLPTR));
        dc_where->clear();
        dc_where->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "HEN_HOUSE", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "EGS_HOME", Q_NULLPTR)
        );
        dc_button->setText(QApplication::translate("EGS_PegsPage", "...", Q_NULLPTR));
        groupBox5->setTitle(QApplication::translate("EGS_PegsPage", "Energy range", Q_NULLPTR));
        textLabel1->setText(QApplication::translate("EGS_PegsPage", "AE", Q_NULLPTR));
        ae_units->clear();
        ae_units->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "keV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "MeV", Q_NULLPTR)
        );
        textLabel2->setText(QApplication::translate("EGS_PegsPage", "AP", Q_NULLPTR));
        ap_units->clear();
        ap_units->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "keV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "MeV", Q_NULLPTR)
        );
        textLabel3->setText(QApplication::translate("EGS_PegsPage", "UE", Q_NULLPTR));
        ue_units->clear();
        ue_units->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "keV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "MeV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "GeV", Q_NULLPTR)
        );
        textLabel4->setText(QApplication::translate("EGS_PegsPage", "UP", Q_NULLPTR));
        up_units->clear();
        up_units->insertItems(0, QStringList()
         << QApplication::translate("EGS_PegsPage", "keV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "MeV", Q_NULLPTR)
         << QApplication::translate("EGS_PegsPage", "GeV", Q_NULLPTR)
        );
        groupBox10->setTitle(QApplication::translate("EGS_PegsPage", "PEGS Output", Q_NULLPTR));
        new_data_file->setText(QApplication::translate("EGS_PegsPage", "Create new data file", Q_NULLPTR));
        append_to_datafile->setText(QApplication::translate("EGS_PegsPage", "Append to existing data file", Q_NULLPTR));
        textLabel6->setText(QApplication::translate("EGS_PegsPage", "Output file", Q_NULLPTR));
        ofile_b->setText(QApplication::translate("EGS_PegsPage", "...", Q_NULLPTR));
        go_button->setText(QApplication::translate("EGS_PegsPage", "&Go", Q_NULLPTR));
        cancel_button->setText(QApplication::translate("EGS_PegsPage", "&Cancel", Q_NULLPTR));
        details_b->setText(QApplication::translate("EGS_PegsPage", "&Details>>", Q_NULLPTR));
    } // retranslateUi
