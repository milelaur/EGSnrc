...
public:
    ...
    {
        PEGS_RunOutput->setWindowTitle(QApplication::translate("PEGS_RunOutput", "PEGS Output", nullptr));
        pushButton8->setText(QApplication::translate("PEGS_RunOutput", "&Close", nullptr));
    } // retranslateUi
