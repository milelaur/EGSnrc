     ...
     * OUTFILE
      ...
      REAL AXISDOSE(15,400)
      REAL DDBIN_CHI
      REAL DDBIN_DIFF
      REAL DOSE(15,28,28,400)
      REAL ERRDOSE(15,28,28,400)
      REAL ERRY(400)
      REAL FREQ_CHI(400)
      REAL FREQ_DIFF(400)
      REAL PROFILEDOSE(400+1),PROFILERR(400+1)
      REAL TOTALNORM(15)
      REAL XCOORD, YCOORD, ZCOORD
      REAL XBOUND(15,28+1),YBOUND(15,28+1), ZBOUND(15,400+1)
      REAL X(400),Y(400)
      REAL VOXEL_MEAS
...
1470  FORMAT(/1X,'Number of voxels in X,Y,Z directions: ',3I10)
      IF ((IMAX(NDIST1) .GT. 28 .OR. JMAX(NDIST1) .GT. 28 .OR. KMAX(NDIS
     *T1) .GT. 400)) THEN
        WRITE(6,1480)28,28,400
