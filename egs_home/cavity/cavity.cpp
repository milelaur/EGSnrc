                        ...
                        the_epcont->edep && the_stack->iq[np])
                {
                    ...
                    if (xb > flu_xmin && xe < flu_xmax)
                    {
                        ...
                        if (xb < flu_xmax)
                        {
                            ...
                            {
                                ab -= jb;   // particle's energy above Emax
                            }
                        }
                        else
                        {
        ...
        if (flup)
        {
            ...
            for (int j = 0; j < ngeom; j++)
            {
                ...
                for (int i = 0; i < flu_nbin; i++)
                {
                    ...
                    totFe += fe * the_bw;
                    totFeErr += dfe * dfe * the_bw * the_bw;
                    totFp += fp * the_bw;
                    totFpErr += dfp * dfp * the_bw * the_bw;
                }
                /*****************************************************************
                 ...
                 * be independent.
                 ******************************************************************/
                if (totFe > 0) totFeErr = 100 * sqrt(totFeErr) / totFe;
                else totFeErr = 100;
                if (totFp > 0) totFpErr = 100 * sqrt(totFpErr) / totFp;
                else totFpErr = 100;
